...
const AdminDashboard: React.FC<AdminDashboardProps> = ({ user, onLogout }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      {/* Sidebar */}
      <div className={`${sidebarOpen ? 'w-64' : 'w-16'} bg-white shadow-lg transition-all duration-300 ease-in-out admin-scrollbar`} style={{overflowY: 'auto', maxHeight: '100vh'}}>
        <div className="p-4">
      ...
      {/* Main Content */}
      <div className="flex-1 flex flex-col admin-scrollbar" style={{overflowY: 'auto', maxHeight: '100vh'}}>
        {/* Header */}
        ...
        <main className="flex-1 p-6 overflow-y-auto">
          <div className="admin-scrollbar" style={{height: '100%', overflowY: 'auto'}}>
            {renderContent()}
          </div>
        </main>
      </div>
